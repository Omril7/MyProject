        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateMinute = table.Column<int>(type: "int", nullable: true),
                    DateHour = table.Column<int>(type: "int", nullable: true),
                    DateDay = table.Column<int>(type: "int", nullable: true),
                    DateMonth = table.Column<int>(type: "int", nullable: true),
                    DateYear = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    _grade = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Submissions_Exams_ExamId1",
                        column: x => x.ExamId1,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
